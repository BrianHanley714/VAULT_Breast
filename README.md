...
Scripts can be run on a standard desktop computer and each script should run in seconds.

Expected outputs are present in the [figures](https://github.com/BrianHanley714/VAULT_Breast/tree/main/analysis/figures) directory.
